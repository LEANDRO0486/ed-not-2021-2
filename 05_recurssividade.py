...
# É igual ao número n multiplicado por todos os seus antecessores ate 1
#
# 
...
# iplementação iterativa (iter = caminho)
def fatorial(n):
    resultado = 1
    if(n > 1):
...
# n! = n * (n - 1)! p/ n > 1
# recursividade ocorre quando a definição de uma função inclui a propria
# função sendo definida

# Em programação, a recursividade se traduz quando uma função efetua
# chamadas a is própria.
